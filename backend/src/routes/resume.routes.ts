...
import { createResume, deleteResume, getResumeById, getResumeRoastsById, updateResume, getResumes, uploadResumeFile, getMyResumes, detectPiiFromFile } from '../controllers/resume.controller';
...
router.post('/detect-pii', authenticateToken, uploadLimiter, uploadResumeMiddleware.single('file'), validateUploadMagicBytes, detectPiiFromFile);
